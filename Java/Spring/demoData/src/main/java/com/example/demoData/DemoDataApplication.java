...
public class DemoDataApplication implements CommandLineRunner {
	...
	@PostConstruct
	public void init() {
		//initialisation possible des attributs injectés
		//maisonService.create(new Maison("Le lieu", "La Selle Craonnaise"));
		//maisonService.create(new Maison("Ici pas là", "Nantes"));
	}
